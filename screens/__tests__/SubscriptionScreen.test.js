...
describe('SubscriptionScreen', () => {
  ...
  describe('addon purchase flow', () => {
    ...
    // NOTE: pending-addon-grant retry tests moved to
    // components/__tests__/PendingAddonGrantRetrier.test.js — the retry
    // logic now lives at the app root, not on this screen. See
    // DawnoTemu/mobile#21.
  });
